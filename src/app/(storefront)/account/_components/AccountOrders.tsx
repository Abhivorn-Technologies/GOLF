                  ...
                  <div className="flex flex-col gap-6 w-full">
                    {order.products?.map((item: any, idx: number) => (
                      <div key={idx} className="flex gap-6 items-center">
                        <Link href={`/product/${item.product.slug || item.product._id}`} className="w-24 h-24 bg-gray-50 rounded-xl flex items-center justify-center p-3 shrink-0 border border-gray-100 hover:border-black transition-colors">
                        ...
                        <div className="flex flex-col gap-1.5 flex-1">
                          <Link href={`/product/${item.product?.slug || item.product?._id}`} className="text-black text-lg font-black tracking-tight leading-tight hover:underline hover:text-green-800">
                            {item.product?.name}
                          </Link>
