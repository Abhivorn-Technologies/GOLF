        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-[32px]">
          {products.map((product) => (
            <div key={product._id} className="bg-white border border-[#c1c9bf] rounded-[16px] p-[24px] hover:shadow-md transition-shadow group flex flex-col h-full">
              <Link href={`/product/${product._id}`} className="w-full aspect-[4/3] bg-[#fbf9f9] rounded-[8px] mb-[24px] overflow-hidden relative flex items-center justify-center">
              ...
              <div className="flex flex-col flex-grow">
                <Link href={`/product/${product._id}`} className="text-[20px] font-serif font-semibold text-[#1b1c1c] group-hover:text-green-700 transition-colors leading-tight mb-[8px]">
                  {product.title}
                </Link>
              ...
              <div className="pt-[16px] border-t border-[#c1c9bf] flex justify-between items-center mt-auto">
                ...
                <Link href={`/product/${product._id}`} className="w-[48px] h-[48px] rounded-full border border-[#c1c9bf] flex items-center justify-center hover:bg-[#003319] hover:border-[#003319] hover:text-white text-[#1b1c1c] transition-colors group-hover:bg-[#003319] group-hover:text-white">
