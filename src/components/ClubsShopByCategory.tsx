    ...
    <div className="w-full mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {displayCategories.map((cat) => (
          <Link key={cat.id} href={cat.href || '#'} className="group relative h-[320px] rounded-2xl overflow-hidden bg-zinc-100 flex flex-col justify-end p-6 border border-gray-200 transition-all duration-300 hover:border-[#006747] hover:shadow-lg">
