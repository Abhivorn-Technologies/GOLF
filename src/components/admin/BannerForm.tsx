        ...
        <div className="space-y-6">
          <div>
            ...
            <input 
              ...
              placeholder="e.g. Summer Golf Sale"
            />
          </div>
          ...
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 bg-white focus:border-black focus:ring-2 focus:ring-gray-200 transition-all outline-none"
              placeholder="e.g. Up to 40% off premium clubs"
            />
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Target Link URL (Optional)</label>
            <input 
              name="linkUrl" 
              defaultValue={initialData?.linkUrl} 
              className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 bg-white focus:border-black focus:ring-2 focus:ring-gray-200 transition-all outline-none"
              placeholder="e.g. /category/clubs"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <label htmlFor="isActive" className="text-sm font-medium text-gray-700">Banner is Active</label>
          </div>
        </div>

        {/* Image Upload Area */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Hero Image (Landscape recommended)</label>
          <div className="border-2 border-dashed border-gray-300 rounded-2xl h-[300px] flex flex-col items-center justify-center relative bg-gray-50/50 hover:bg-gray-50 transition-colors overflow-hidden group">
            {imagePreview ? (
              <>
